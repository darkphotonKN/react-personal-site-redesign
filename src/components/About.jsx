    ...
    render() { 
        return ( 
            <div className='row about section '>
                <div className="col-6">
                    <h1>About</h1>
                    <p className={"section-p " + (this.props.sectionActive ? 'is-active' : null)}>I'm a Software Engineering graduate who earned a passion for coding and web development ever since I saw some code online
                    ...
                    sites / web applications; using java and python; and also knowledge in security for computers which I took an advanced course for in my final year of studies.</p>
                </div>
